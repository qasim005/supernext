      ...
      <header className="absolute top-0 left-0 w-full z-30 px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
                ...
                <span className="text-3xl font-bold text-white">SuperNext Cloud</span>
            </div>
            <div className="flex items-center gap-4">
                ...
                <button onClick={onNavigateToLogin} className="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                    Client Login
                </button>
            </div>
        </div>
